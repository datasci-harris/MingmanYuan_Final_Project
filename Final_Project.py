...
scale_lst = ['H1B_Average_Wage', 'TechSciScore',
             'percent_move_from_abroad_above_college_degree', 'H1B_Case_Number', 'H1B_Employer_Number']
...
def splitMerge(Merge1, Merge2):
    ...
    global X_test
    global Y_test
    X_train = Merge2.drop(['H1B_Case_Number_Percent', 'H1B_Case_Number'], axis=1)
    Y_train = Merge2['H1B_Case_Number']
    X_test = Merge1.drop(['H1B_Case_Number_Percent', 'H1B_Case_Number'], axis=1)
    Y_test = Merge1['H1B_Case_Number']
